...
//This is used to center the generated map
...
world_name_template = array("willes", "ren", "una", "hael", "sles", "ashal",
							...
							"esfe", "ilen", "lore", "magi", "chan", "coin",
							"amy", "shait", "weva", "yefe", "eny", "rafe",
							"yellow", "red", "blue", "green", "folk", "moor",
							"hogs", "rock", "ville", "shire", "by", "vock",
							"sheen", "hir", "ton", "daven", "waite", "keld",
							"san", "wick", "field", "moon", "god", "peace");
...
world_name_c = world_name_template[ irandom_range(0, array_length_1d(world_name_template)-1) ];